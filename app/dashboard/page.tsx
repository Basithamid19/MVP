...
// Unified status system — dot color + label + progress step
...
// Unified status dot — single consistent badge style across all cards
...
// 4-segment progress bar — hidden for terminal states
...
export default function DashboardPage() {
  ...
  // Contextual subtitle — one clear status line, no static copy
  ...
  // Single priority banner — quotes take precedence; booking reminder lives in Bookings page
      ...
      <div className="flex-1 min-w-0 flex flex-col">
        ...
        <main className="flex-1 overflow-y-auto p-6 lg:p-8">
          <div className="max-w-5xl mx-auto">
            ...
            {/* ── Single priority banner — quotes only ──────── */}
            {showQuotesBanner && (
                  ...
                  <div className="grid grid-cols-3 sm:grid-cols-6 gap-2">
                    {POPULAR_SERVICES.map(({ label, slug, emoji }) => (
                      <Link
                        ...
                        className="bg-white border border-gray-100 shadow-sm rounded-2xl p-3 flex flex-col items-center gap-1.5 text-center hover:shadow-md transition-all group"
                      >
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white border border-gray-100 shadow-sm rounded-2xl p-4">
                  <div className="flex items-center justify-between mb-3">
                    <h3 className="font-semibold text-sm text-gray-700">Recommended Pros</h3>
                  ...
                  {topPros.length === 0 ? (
                    ...
                    <div className="space-y-2">
                      {topPros.map(pro => (
                        ...
                        >
                          <div className="w-8 h-8 rounded-xl bg-gray-100 overflow-hidden shrink-0 grayscale group-hover:grayscale-0 transition-all">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-1 mt-0.5">
                              ...
                              <span className="text-xs text-gray-400">{pro.ratingAvg?.toFixed(1) ?? '—'}</span>
                          ...
                          {pro.isVerified && <ShieldCheck className="w-3.5 h-3.5 text-blue-400 shrink-0" />}
                        </Link>
                      ))}
                    </div>
                  )}
