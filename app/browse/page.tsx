            ...
            <div className="grid md:grid-cols-2 gap-5">
              {providers.map((p) => (
                <Link
                  key={p.id}
                  href={`/providers/${p.id}`}
                  className="group bg-white p-6 rounded-panel border border-border-dim shadow-sm hover:border-brand/30 transition-all hover:shadow-elevated flex flex-col"
                >
                  <div className="flex items-start justify-between mb-6">
                    <div className="flex items-center gap-4">
                      <div className="w-14 h-14 bg-surface-alt rounded-card overflow-hidden transition-all">
                      ...
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          {p.isVerified && (
                            <div className="w-5 h-5 bg-trust text-white rounded-full flex items-center justify-center">
                  ...
                  <div className="mt-auto flex items-center justify-between pt-5 border-t border-border-dim">
