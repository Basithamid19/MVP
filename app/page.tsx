          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-20 items-start">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="pt-0 lg:pt-12 w-full min-w-0">
              ...
              <div className="mt-4 mb-1">
                ...
                >
                  <div className="w-10 h-10 bg-[#F3E5D8] rounded-2xl flex items-center justify-center shrink-0 shadow-sm">
                    <Users className="w-[18px] h-[18px] text-[#7C4A2D]" />
                  </div>
                ...
                <Link
                  ...
                  className="flex items-center gap-4 pt-5 pb-7 rounded-xl hover:bg-surface-alt active:bg-surface-alt transition-colors -mx-1 px-1"
                >
                  <div className="w-10 h-10 bg-[#D4AF37] rounded-2xl flex items-center justify-center shrink-0 shadow-sm">
                ...
                >
                  <div className="w-10 h-10 bg-[#E2725B] rounded-2xl flex items-center justify-center shrink-0 shadow-sm">
